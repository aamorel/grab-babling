...
register(id='kuka_robotiq-v0', entry_point='gym_grabbing.envs:KukaRobotiq',max_episode_steps=2500)
...
register(id='jaco_grasping-v0', entry_point='gym_grabbing.envs:JacoGrasping', max_episode_steps=2500)
